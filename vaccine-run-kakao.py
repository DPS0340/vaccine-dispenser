...
retries = urllib3.util.Retry(total=5, allowed_methods=frozenset(['GET', 'POST']))
...
# print(jar)
UserInfo_response = requests.get(UserInfoAPI, headers=headers.headers_vacc, cookies=jar, verify=False, retries=True)
